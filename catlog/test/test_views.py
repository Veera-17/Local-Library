...
import datetime
from catlog.models import BookInstance, Book, Genre, Language, Author
...
class AuthorListViewTest(TestCase):
    ...
    def test_view_url_exists_at_desired_location(self):
        response = self.client.get('/catlog/authors/')
    ...
    def test_view_uses_correct_template(self):
        response = self.client.get(reverse('authors'))
        self.assertEqual(response.status_code, 200)
        self.assertTemplateUsed(response, 'catlog/author_list.html')
...
class LoanedBookInstancesByUserListViewTest(TestCase):
    ...
    def test_redirect_if_not_logged_in(self):
        ...
        self.assertRedirects(response, '/accounts/login/?next=/catlog/mybooks/')
    ...
    def test_logged_in_uses_correct_template(self):
        ...
        self.assertTemplateUsed(response, 'catlog/bookinstance_list_borrowed_user.html')
...
class RenewBookInstancesViewTest(TestCase):
    ...
    def test_uses_correct_template(self):
        ...
        # Check we used correct template
        self.assertTemplateUsed(response, 'catlog/book_renew_librarian.html')
